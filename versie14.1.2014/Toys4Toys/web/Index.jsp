<%-- 
    Document   : Index
    Created on : 10-jan-2015, 14:13:41
    Author     : Tom
--%>
...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <img src="Images/easy-foto-collage-masking-tape.jpg" alt="collage"/>
            ...
            Sociaal, kinderen en ouders kunnen in contact komen met andere uit de buurt.</br>
            Er is in het huis minder ruimte nodig om al het speelgoed op te slaan.</br>
        </div>
        <footer>
