 ...
 * @author Eric
 */
public class BabyRuilen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pId = p.getId();
         ...
         request.getSession().setAttribute("vm5", baby);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("BabyspullenRuilen.jsp");
