 ...
 * @author Eric
 */
public class KlerenRuilen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pId = p.getId();
         ...
         List<Kleren> kleren = KlerenService.SelecteerKleren(Integer.parseInt(request.getParameter("id")));

         request.getSession().setAttribute("vm5", kleren);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("KlerenRuilen.jsp");
